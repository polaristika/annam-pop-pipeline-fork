...
from pop_cli_commands.commands.zoho_auth import add_parser as add_zoho_auth_parser
from pop_cli_commands.commands.dedup import add_parser as add_dedup_parser
from pop_cli_commands.commands.zoho_download import add_parser as add_zoho_download_parser
from pop_cli_commands.commands.ingest_docs import add_parser as add_ingest_docs_parser
from pop_cli_commands.commands.ingest_chunks import add_parser as add_ingest_chunks_parser
...
Zoho + MongoDB pipeline (runs in order):
  pop-cli zoho-auth                         # Exchange OAuth code → zoho_tokens.json
  pop-cli dedup                             # Find unique PDFs via perceptual hash
  pop-cli zoho-download --links unique_urls.xlsx  # Download deduplicated PDFs
  pop-cli ingest-docs                       # Create MongoDB document records
  pop-cli ingest-chunks                     # Embed and chunk into MongoDB
...
For more help on any command, use:
  pop-cli <command> --help
    ...
    # Zoho + MongoDB pipeline commands
    add_zoho_auth_parser(subparsers)
    add_dedup_parser(subparsers)
    add_zoho_download_parser(subparsers)
    add_ingest_docs_parser(subparsers)
    add_ingest_chunks_parser(subparsers)
